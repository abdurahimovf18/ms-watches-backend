...
Revision ID: 8229c759d2b2
Revises: cf905f5f8f88
Create Date: 2025-01-14 18:28:13.901241
...
revision: str = '8229c759d2b2'
down_revision: Union[str, None] = 'cf905f5f8f88'
...
def upgrade() -> None:
    ...
    op.create_index('country_id', 'brands_to_countries', [], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('country_id', table_name='brands_to_countries')
