...
Revision ID: a9ed9ab4db8d
Revises: 8229c759d2b2
Create Date: 2025-01-14 18:32:40.240874
...
revision: str = 'a9ed9ab4db8d'
down_revision: Union[str, None] = '8229c759d2b2'
...
def upgrade() -> None:
    ...
    op.create_index('brands_to_countries_index_country_id', 'brands_to_countries', [], unique=False)
